...
const ComponentPicker = ({
  ...
  }, [allFlattenOptions.length, workflowVariableBlock?.show, refs, floatingStyles, isPositioned, workflowVariableOptions, isSupportFileVar, queryString, handleSelectWorkflowVariable])
