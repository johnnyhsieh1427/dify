...
const ChatWrapper = () => {
  ...
  const doSend: OnSend = useCallback((message, files, isRegenerate = false, parentAnswer: ChatItem | null = null) => {
    ...
    handleSend(
      getUrl(`chat-messages/${appDataList?.[activeIndex || 0].app_id}`, false, appDataList?.[activeIndex || 0].app_id || ''),
      data,
      {
  ...
  }, [currentConversationId, currentConversationInputs, newConversationInputs, chatList, handleSend, appDataList, activeIndex, handleNewConversationCompleted, isInstalledApp, appId])
