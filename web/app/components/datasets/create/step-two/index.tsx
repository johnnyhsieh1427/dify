            ...
            <div className='flex flex-col gap-y-4'>
              <div className='flex gap-3'>
                ...
                <MaxLengthInput
                  ...
                  onChange={value => setMaxChunkLength(value ?? DEFAULT_MAXIMUM_CHUNK_LENGTH)}
                />
                <OverlapInput
                  unit='characters'
                  value={overlap}
                  min={1}
                  onChange={value => setOverlap(value ?? overlap)}
                />
              </div>
                    ...
                    <div className='flex gap-3'>
                      ...
                      <MaxLengthInput
                        ...
                        onChange={value => setParentChildConfig({
                          ...
                          parent: {
                            ...parentChildConfig.parent,
                            maxLength: value ?? DEFAULT_MAXIMUM_CHUNK_LENGTH,
                          },
                        })}
                      />
                    </div>
