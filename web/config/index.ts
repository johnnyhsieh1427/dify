...
export const WEB_CHAT_API_PREFIX = getStringConfig(process.env.NEXT_PUBLIC_WEB_CHAT_API_PREFIX, DatasetAttr.DATA_PUBLIC_WEB_CHAT_API_PREFIX, 'http://localhost:5001/web-chat/api')
