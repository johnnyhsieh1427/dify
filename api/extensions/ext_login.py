...
from libs.token import extract_access_token, extract_chat_app_passport, extract_webapp_passport
...
def load_user_from_request(request_from_flask_login):
    ...
    elif request.blueprint == "web_user":
        app_code = request.headers.get(HEADER_NAME_APP_CODE)
        chat_app_token = extract_chat_app_passport(request) if app_code else None
        
        if chat_app_token:
            decoded = PassportService().verify(chat_app_token)
