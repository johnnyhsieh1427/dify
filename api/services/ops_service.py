...
class OpsService:
    ...
    @classmethod
    def create_tracing_dataset_config(cls, dataset_id: str, tracing_provider: str, tracing_config: dict):
        """
        Create tracing dataset config
        :param dataset_id: dataset id
        :param tracing_provider: tracing provider
        :param tracing_config: tracing config
        :return:
    ...
    @classmethod
    def delete_tracing_dataset_config(cls, dataset_id: str, tracing_provider: str):
        """
        Delete tracing app config
        :param app_id: app id
        :param tracing_provider: tracing provider
        ...
        trace_config = (
            db.session.query(TraceDatasetConfig)
            .filter(TraceDatasetConfig.dataset_id == dataset_id, TraceAppConfig.tracing_provider == tracing_provider)
            .first()
        )
