...
@web_chat_ns.route("/files/upload")
class FileApi(WebUserApiResource):
    @web_chat_ns.doc("upload_file")
    @web_chat_ns.doc(description="Upload a file for use in web user applications")
    @web_chat_ns.doc(
        responses={
    ...
    @marshal_with(build_file_model(web_chat_ns))
