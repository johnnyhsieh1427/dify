...
@web_chat_ns.route("/remote-files/<path:url>")
class RemoteFileInfoApi(WebUserApiResource):
    @web_chat_ns.doc("get_remote_file_info")
    @web_chat_ns.doc(description="Get information about a remote file")
    @web_chat_ns.doc(
        responses={
    ...
    @marshal_with(build_remote_file_info_model(web_chat_ns))
    def get(self, app_models, end_user, url):
...
@web_chat_ns.route("/remote-files/upload")
class RemoteFileUploadApi(WebUserApiResource):
    @web_chat_ns.doc("upload_remote_file")
    @web_chat_ns.doc(description="Upload a file from a remote URL")
    @web_chat_ns.doc(
        responses={
    ...
    @marshal_with(build_file_with_signed_url_model(web_chat_ns))
