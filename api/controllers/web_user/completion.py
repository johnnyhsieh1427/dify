...
api.add_resource(CompletionApi, "/completion-messages/<uuid:app_id>")
api.add_resource(CompletionStopApi, "/completion-messages/<uuid:app_id>/<string:task_id>/stop")
api.add_resource(ChatApi, "/chat-messages/<uuid:app_id>")
api.add_resource(ChatStopApi, "/chat-messages/<uuid:app_id>/<string:task_id>/stop")
